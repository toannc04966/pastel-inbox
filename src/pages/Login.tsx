    ...
    >
      <div className="w-full max-w-[420px]">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="space-y-[6px]">
              <Label 
                htmlFor="email"
                className="text-[13px]"
                style={{ color: 'rgba(15, 23, 42, 0.80)' }}
              >
                Email
              </Label>
              <Input
              ...
              <div className="min-h-[18px]">
                {validationErrors.email && (
                  <p 
                    className="text-[13px]"
                    style={{ color: 'rgba(190, 18, 60, 0.95)' }}
                  >
                    {validationErrors.email}
                  </p>
                )}
          ...
          {/* Security Notice */}
          <p 
            className="text-[12px] text-center mt-[14px]"
          ...
          {/* Copyright & Legal */}
          <div 
            className="text-[11px] text-center leading-[1.5] mt-[18px]"
            style={{ color: 'rgba(15, 23, 42, 0.45)' }}
          >
            <p>© 2025 bpink.io.vn. All rights reserved.</p>
            <p className="mt-1">
              By signing in, you agree to our{' '}
              <span className="underline cursor-pointer hover:opacity-80">Terms of Service</span>
              {' '}and{' '}
